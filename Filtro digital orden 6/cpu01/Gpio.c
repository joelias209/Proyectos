...
//--- Group A pins
	...
	GpioCtrlRegs.GPADIR.all   = 0x00000001;		// All GPIO are inputs
...
//--- Select pin configurations
	...
	/*GpioDataRegs.GPADAT.all = OxFFFFFFFF; //Escribe un
	GpioDataRegs.GPACLEAR.all = 0XFFFFFFFF; //
	GpioDataRegs.GPASET.bit.GPIO1 = 1; //Escribe un 1
	GpioDataRegs.GPADAT.bit.GPIO1 = 0; //Escribe un 0
	GpioDataRegs.GPADAT.all = 0F1CD234; */
